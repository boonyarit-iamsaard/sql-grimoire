...
| `apps/web/src/assets/maps/world-map.svg`                                            | Hand-authored for this prototype                                   | Same as project (no third-party rights)                  |
| `apps/web/src/assets/characters/merchant/{neutral,worried,happy}.svg`               | Hand-authored for this prototype                                   | Same as project                                          |
| `apps/web/src/assets/characters/archivist/{neutral,stern,troubled}.svg`             | Hand-authored for this prototype                                   | Same as project                                          |
| `apps/web/src/assets/locations/{merchant-guild,inner-archives,locked-location}.svg` | Hand-authored for this prototype                                   | Same as project                                          |
| `apps/web/src/assets/ui/xp-icon.svg`                                                | Hand-authored for this prototype                                   | Same as project                                          |
